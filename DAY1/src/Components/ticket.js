...
import "./ticket.css";
import air from "./airplane.png";
import Navbar2 from './navbar2';
import Sidebar from './sidebar';
import flight from "./booking.png";
import bar from "./bar1.avif"
function Ticket() {
    return ( 
      <>
      <Navbar2/>
    ...
    <div className='tickettop'>
         <div className='ticketcard'>
            <div className='ticketcard2'>
               ...
               <div className="texts">
                  <h2 id="t2i"><span id="t21">Book</span><span id="t22">MyTicket</span></h2>
               </div>
            </div>
            <div className="flight-comp-dest">
              <div className="flight-comp-dest-child1">
                ...
                <div className="flight-flight1">
                  ...
                  <img className="imgff" src={air}></img>
                  <div className="tag">
                    <hr className="hr-tag"></hr>
                  </div>
                </div>
